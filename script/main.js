...
function createSparkles() {
  const colors = ['#ff6eb4', '#c084fc', '#ffd700', '#ff85c8', '#7dd175'];
  for (let i = 0; i < 18; i++) {
...
const animationTimeline = () => {
  ...
  tl.to(".container", 0.6, { visibility: "visible" })
    ...
    .staggerTo(".hbd-chatbox span", 1.5, { visibility: "visible" }, 0.045)
...
// Fetch customize.json dulu, baru jalankan animasi
const fetchData = () => {
